...
"""Integrity guards for the cancerdata-owned cancer-type registry.

cancerdata owns the cancer-type ontology outright — the registry is authoritative
...
_CSV = Path(__file__).resolve().parents[1] / "cancerdata" / "data" / "cancer-type-registry.csv"
