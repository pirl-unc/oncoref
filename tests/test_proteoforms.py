...
from oncoref.expression_builders import sum_proteoform_tpm
from oncoref.proteoforms import _contract_members
...
def test_proteoform_key_ensg_for_unique_symbol_for_group():
    from oncoref.proteoforms import proteoform_key
