...
``normal_tissue`` for IHC), using :func:`oncoref.cta_regen.regenerate_cta_columns`.
The HPA tables are downloaded + cached on first use via the oncoref accessors.
...
from oncoref.cta_regen import (  # noqa: E402
    PRESERVED_COLUMNS,
    RECOMPUTED_COLUMNS,
